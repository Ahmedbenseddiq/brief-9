            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse me-5" id="navbarNav">
                    <ul class="navbar-nav ms-auto"> <!-- Changed class to ms-auto -->
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="#">Manage Scheduale</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Manage schedule</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <section class="text-center">
            ...
            <div class="card-body py-5 px-md-5">
                ...
                <div class="col-lg-8">
                    <h2 class="fw-bold mb-5">Create new scheduale</h2>
                    <form>
                        <div class="row">
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-block mb-4">Add Road</button>
                    </form>
